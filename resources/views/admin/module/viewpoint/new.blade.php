            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            @component($prefix_component."form",['action'=>route('admin.viewpoint.store'),'upload_file'=>true])
                                @slot("content")
                                    ...
                                    @component($prefix_component."textarea",['name'=>'note','title'=>'دیدگاه','value'=>old('note')])@endcomponent
