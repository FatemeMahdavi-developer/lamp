...
@section("content")
    ...
    <div class="section-body">
        ...
        <div class="card-body">
        @component($prefix_component.".form",['action'=>route('admin.project_cat.store'),'method'=>'post','upload_file'=>true])
            @slot("content")
                @component($prefix_component."navtab",['number'=>2,'titles'=>['موارد سئو','اطلاعات کلی']])
                    ...
                    @slot("tabContent1")
                        ...
                        @component($prefix_component."select_recursive",['name'=>'catid','options'=>$project_cats,'label'=>'دسته بندی','first_option'=>'دسته بندی اصلی', 'sub_method'=>'sub_cats','value'=>old('catid')])@endcomponent
                        @component($prefix_component."upload_file",['name'=>'pic','title'=>'تصویر svg','value'=>old('pic'),'class'=>'w-50','module'=>$module])@endcomponent
