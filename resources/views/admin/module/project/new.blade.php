            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            @component($prefix_component.".form",['action'=>route('admin.project.store'),'method'=>'post','upload_file'=>true])
                                @slot("content")
                                    @component($prefix_component."navtab",['number'=>2,'titles'=>['موارد سئو','اطلاعات کلی']])
                                        ...
                                        @slot("tabContent1")
                                            ...
                                            @component($prefix_component."select_recursive",['name'=>'catid','options'=>$project_cats,'label'=>'موضوع', 'sub_method'=>'sub_cats','value'=>old('catid'),'choose'=>true])@endcomponent
