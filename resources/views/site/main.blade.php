...
<div class="content-wrap ">
            ...
            <div class="row gy-50">
                ...
                <div class="col-lg-6 offset-lg-1">
                    <div class="position-relative shape-parent mt-80">
                        ...
                        <div class="position-absolute start-0 top-0 mt-n80" data-img-height style="--img-height: 100%; width: 230px;"><img class="rounded-4" loading="lazy" src="{{asset('site/assets/img/about-us-4-900x990.jpg ')}}" alt=""></div>
                        <div class="ms-100" data-img-height style="--img-height: 70%;" data-show="startbox"><a class="image-link" href="assets/img/about-us-3-900x630.jpg"><img class="rounded-4" loading="lazy" src="{{asset('site/assets/img/about-us-3-900x630.jpg ')}}" alt=""></a></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="pt-120 pb-130 bg-dark shape-parent overflow-hidden">
        <!-- Shape-->
        <div class="shape justify-content-end"><img loading="lazy" src="{{asset('site/assets/img/root/home-1-shape-936x252.png ')}}" alt="" width="936" height="252"></div><!-- Shape-->
        <div class="shape justify-content-start align-items-end"><img loading="lazy" src="{{asset('site/assets/img/root/home-1-shape-308x487.png ')}}" alt="" width="308" height="487"></div>
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h3 class="mb-25 text-white text-center" data-show="startbox">آیا مشاوره رایگان می خواهید؟</h3>
                    <p class="m-0 text-white text-center" data-show="startbox" data-show-delay="100">بیا صحبت کنیم. با ما تماس بگیرید / ایمیل بزنید یا از فرم تماس استفاده کنید.</p>
                    <div class="bg-dark-light rounded-4 mt-90 py-60 px-70" data-show="startbox" data-show-delay="200">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0 d-none d-xl-block ms-40"><img class="rounded-circle" loading="lazy" src="{{asset('site/assets/img/root/avatar-1-200x200.jpg ')}}" alt="" height="100" width="100"></div>
                            <div class="flex-grow-1">
                                <ul class="d-flex d-lg-inline-flex list-group flex-lg-row mb-30 borderless">
                                    <li class="list-group-item d-flex"><svg class="ms-15 align-self-center text-accent-3 img-svg" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none">
                                    ...
                                    <li class="list-group-item d-flex mt-10 me-lg-45 mt-lg-0"><svg class="ms-15 align-self-center text-accent-3" xmlns="http://www.w3.org/2000/svg" width="14" height="11" fill="none">
                                        ...
                                        </svg><a class="text-white" href="mailto:help@startbox.com">help@example.com</a></li>
                                </ul>
                                <div class="text-white font-size-16">علی حسینی</div>
                                <div class="font-size-15 text-gray mt-5">کارشناس ارشد دیجیتال مارکتنیگ</div>
                            </div>
                        </div>
                    </div><!-- Form-->
                    <form class="mt-75" data-show="startbox">
                        <div class="row gy-40">
                            <div class="col-12 col-md-6"><input class="form-control form-control-gray" type="text" placeholder="نام و نام خانوادگی *"></div>
                            <div class="col-12 col-md-6"><input class="form-control form-control-gray" type="email" placeholder="ایمیل *"></div>
                            <div class="col-12 col-md-6"><input class="form-control form-control-gray" type="tel" placeholder="شماره تماس *"></div>
                            <div class="col-12 col-md-6"><select class="form-control form-control-gray">
                                    <option selected="">فرصت های شغلی</option>
                            ...
                            <div class="col-12 mb-10"><textarea class="form-control form-control-gray" rows="2" placeholder="متن درخواست *"></textarea></div>
                            <div class="col-12 text-center">
                                <!-- Button--><button class="btn btn-accent-1">ارسال</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="row align-items-center gy-90">
                <div class="col-lg-6 shape-parent">
                    ...
                    <div class="gallery-wrapper ms-lg-70" data-show="startbox">
                        <!-- Gallery item--><a class="gallery-item rounded-4 overflow-hidden" href="assets/img/home-1-900x990.jpg" style="--img-height: 110%;" data-img-height><img loading="lazy" src="{{asset('site/assets/img/home-1-900x990.jpg ')}}" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6"><span class="badge bg-light text-dark mb-20" data-show="startbox">مشتریان</span>
                    <h3 class="mb-30" data-show="startbox" data-show-delay="100"><span class="highlight">رضایت مشتری</span> اولویت اول ماست</h3>
                    <p class="mb-45 ms-lg-70" data-show="startbox" data-show-delay="200">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است..</p>
                    ...
                    <div class="row mt-50 g-15 flex-nowrap">
                        <div class="col" data-show="startbox" data-show-delay="400">
                            <!-- Brand--><a class="brand rounded-2 bg-gray-light text-dark brand-sm" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="74" height="20" fill="none">
                        ...
                        <div class="col" data-show="startbox" data-show-delay="500">
                            <!-- Brand--><a class="brand rounded-2 bg-gray-light text-dark brand-sm" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="67" height="34" fill="none">
                ...
                <div class="pt-120 pb-130 px-30 position-relative rounded-4 overflow-hidden z-index-1">
                    ...
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3 text-center">
                            ...
                            <div data-show="startbox" data-show-delay="200">
                                <!-- Button--><a class="btn btn-accent-1" href="contact-01.html" target="_self">تماس با ما <svg class="me-15 align-self-center" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 15 15">
                                        <path fill="currentColor" d="M15 11.23v2.259a1.501 1.501 0 0 1-1.026 1.432c-.199.067-.41.092-.619.073a14.944 14.944 0 0 1-6.508-2.31A14.692 14.692 0 0 1 2.32 8.166 14.877 14.877 0 0 1 .006 1.641 1.503 1.503 0 0 1 .9.13 1.51 1.51 0 0 1 1.507 0H3.77a1.51 1.51 0 0 1 1.508 1.295c.095.722.273 1.432.528 2.115a1.503 1.503 0 0 1-.34 1.588l-.957.956a12.055 12.055 0 0 0 4.525 4.516l.958-.956a1.51 1.51 0 0 1 1.591-.338 9.7 9.7 0 0 0 2.12.527 1.509 1.509 0 0 1 1.296 1.527Z" />
                                    </svg></a>
                            </div>
                        </div>
