    ...
    <nav class="navbar navbar-expand-lg navbar-top  bg-white">
        <div class="container"><a class="navbar-brand" href="index.html"><svg xmlns="http://www.w3.org/2000/svg" width="124" height="30" fill="none" class="dark">
            ...
            <ul class="nav navbar-nav order-2 me-auto nav-no-opacity">
                <li class="nav-item navbar-dropdown"><a class="nav-link" href="index.html"><span>خانه</span></a>
                    <div class="dropdown-menu rounded-2 shadow">
                        <ul class="nav navbar-nav">
                            <li class="nav-item active"><a class="nav-link" href="home-01.html"><span>نسخه 1</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="home-02.html"><span>نسخه 2</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="home-03.html"><span>نسخه 3</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="home-04.html"><span>نسخه 4</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="home-05.html"><span>نسخه 5</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="home-06.html"><span>نسخه 6</span></a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item navbar-dropdown"><a class="nav-link" href="services-01.html"><span>خدمات</span></a>
                    <div class="dropdown-menu rounded-2 shadow">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"><a class="nav-link" href="services-01.html"><span>نسخه 1</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="services-02.html"><span>نسخه 2</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="service-single.html"><span>جزئیات</span></a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item navbar-dropdown"><a class="nav-link" href="about-us.html"><span>صفحات</span></a>
                    <div class="dropdown-menu rounded-2 shadow">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"><a class="nav-link" href="about-us.html"><span>درباره ما</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="about-me.html"><span>درباره من</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="pricing.html"><span>قیمت گذاری</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="team.html"><span>تیم ما</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="404.html"><span>صفحه 404</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="coming-soon.html"><span>به زودی</span></a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item navbar-dropdown"><a class="nav-link" href="projects-01.html"><span>نمونه کارها</span></a>
                    <div class="dropdown-menu rounded-2 shadow">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"><a class="nav-link" href="projects-01.html"><span>نسخه 1</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="projects-02.html"><span>نسخه 2</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="projects-03.html"><span>نسخه 3</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="projects-04.html"><span>نسخه 4</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="projects-05.html"><span>نسخه 5</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="project-single-01.html"><span>جزئیات نسخه 1</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="project-single-02.html"><span>جزئیات نسخه 2</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="project-single-03.html"><span>جزئیات نسخه 3</span></a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item navbar-dropdown"><a class="nav-link" href="blog.html"><span>وبلاگ</span></a>
                    <div class="dropdown-menu rounded-2 shadow">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"><a class="nav-link" href="blog.html"><span>لیست</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="single-post.html"><span>جزئیات</span></a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item navbar-dropdown"><a class="nav-link" href="contact-01.html"><span>تماس با ما</span></a>
                    <div class="dropdown-menu rounded-2 shadow">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"><a class="nav-link" href="contact-01.html"><span>نسخه 1</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="contact-02.html"><span>نسخه 2</span></a></li>
                        </ul>
                    </div>
                </li>
            </ul>
			<!-- Button--><a class="btn d-none d-sm-inline-flex btn btn-sm btn-accent-1 me-auto me-lg-60 ms-30 ms-lg-0 order-2 order-lg-3" href="contact-01.html" target="_self">ارتباط با ما</a>
        </div>
    </nav><!-- Navbar mobile-->
        ...
        <div class="navbar-wrapper">
            ...
            <div class="navbar-body">
                <ul class="nav navbar-nav navbar-nav-collapse">
                    <li class="nav-item navbar-collapse"><a class="nav-link" href="#navbarCollapseHome" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbarCollapseHome"><span>خانه</span></a>
                    ...
                    <li class="nav-item navbar-collapse"><a class="nav-link" href="#navbarCollapseServices" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbarCollapseServices"><span>خدمات</span></a>
                    ...
                    <li class="nav-item navbar-collapse"><a class="nav-link" href="#navbarCollapsePages" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbarCollapsePages"><span>صفحات</span></a>
                    ...
                    <li class="nav-item navbar-collapse"><a class="nav-link" href="#navbarCollapsePortfolio" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbarCollapsePortfolio"><span>نمونه کارها</span></a>
                    ...
                    <li class="nav-item navbar-collapse"><a class="nav-link" href="#navbarCollapseBlog" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbarCollapseBlog"><span>وبلاگ</span></a>
                    ...
                    <li class="nav-item navbar-collapse"><a class="nav-link" href="#navbarCollapseContact" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbarCollapseContact"><span>تماس با ما</span></a>
            ...
            <div class="navbar-footer">
                ...
                <ul class="list-group borderless font-size-15 text-end">
                    <li class="list-group-item">ایمیل: <a href="#">help@example.com</a></li>
                    <li class="list-group-item">تلفن: <a href="tel:02188888888">02188888888</a></li>
                </ul><!-- Social-->
    ...
    <div class="navbar navbar-topbar navbar-expand-xl navbar-dark navbar-absolute top-0 d-none d-xl-flex">
        <div class="container">
            ...
            <ul class="nav navbar-nav nav-gap-xl nav-contacts nav-no-opacity">
                <li class="nav-item"><a class="nav-link" href="tel:02188888888"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none">
                        ...
                        </svg>02188888888</a></li>
                <li class="nav-item"><a class="nav-link" href="mailto:help@example.com"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="11" fill="none">
                ...
                <li class="nav-item"><a class="nav-link" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="12" height="14" fill="none">
                        ...
                        </svg>تهران، میدان ولیعصر، شرکت توسعه پرداز پردیس</a></li>
            </ul><!-- Socials-->
