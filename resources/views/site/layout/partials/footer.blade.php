<footer class="bg-dark text-white pt-120 pb-100 footerNext">
    <div class="container">
        <div class="row gy-50">
            <div class="col-12 col-lg-3"><a class="d-block mb-30" href="index.html"><svg xmlns="http://www.w3.org/2000/svg" width="198" height="48" fill="none">
                ...
                <p class="font-size-15 mb-35">با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
                ...
                <p class="font-size-13 text-muted m-0">© 2022 کلیه حقوق این سایت محفوظ است.</p>
            </div>
            <div class="col-2 d-none d-lg-block"></div>
            <div class="col-12 col-lg-7">
                <div class="row gy-50">
                    <div class="col-6 col-md-4">
                        <h6 class="display-6 text-white mb-20">خدمات</h6>
                        <ul class="nav flex-column text-white nav-opacity nav-gap-sm">
                            <li class="nav-item"><a class="nav-link" href="#">مشاوره</a></li>
                            <li class="nav-item"><a class="nav-link" href="#">منابع انسانی</a></li>
                            <li class="nav-item"><a class="nav-link" href="#">حسابداری</a></li>
                            <li class="nav-item"><a class="nav-link" href="#">مارکتینگ</a></li>
                        </ul>
                    </div>
                    <div class="col-6 col-md-4">
                        <h6 class="display-6 text-white mb-20">لینک های مفید</h6>
                        <ul class="nav flex-column text-white nav-opacity nav-gap-sm">
                    ...
                    <div class="col-6 col-md-4">
                        ...
                        <ul class="nav flex-column text-white nav-opacity nav-gap-sm">
                            <li class="nav-item"><a class="nav-link" href="tel:02188888888">02188888888</a></li>
                            <li class="nav-item"><a class="nav-link" href="tel:09398888888">09398888888</a></li>
                            <li class="nav-item"><a class="nav-link" href="mailto:help@example.com">help@example.com</a></li>
                        </ul>
                    </div>
                </div>
            </div>
