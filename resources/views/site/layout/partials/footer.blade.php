    ...
    <div class="container">
        <div class="row gy-50">
            <div class="col-12 col-lg-3"><a class="d-block mb-30" href="{{route('main')}}"><svg xmlns="http://www.w3.org/2000/svg" width="198" height="48" fill="none">
                    ...
                    @endif
                    @if(app('setting')['youtube_footer'])
                        <li class="nav-item"><a class="nav-link" href="{{app('setting')['youtube_footer']}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="12" fill="none">
                    ...
                    @endif
                    @if(app('setting')['twitter_footer'])
                        <li class="nav-item"><a class="nav-link" href="{{app('setting')['twitter_footer']}}"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="12" fill="none">
                    ...
                    @endif
                    @if(app('setting')['instagram_footer'])
                        <li class="nav-item"><a class="nav-link" href="{{app('setting')['instagram_footer']}}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="13" fill="none">
                ...
                <p class="font-size-13 text-muted m-0">© {{date('Y')}} کلیه حقوق این سایت محفوظ است.</p>
            </div>
            ...
            <div class="col-12 col-lg-7">
                <div class="row gy-50">
                    ...
                    @endif
                    <div class="col-6 col-md-4">
                        <h6 class="display-6 text-white mb-20">راه های ارتباطی</h6>
                        <ul class="nav flex-column text-white nav-opacity nav-gap-sm">
                            @if(isset(app('setting')['tell_footer']))
                            <li class="nav-item"><a class="nav-link" href="tel:{{app('setting')['tell_footer']}}">{{app('setting')['tell_footer']}}</a></li>
                            @endif
                            @if(isset(app('setting')['tell_footer_2']))
                            <li class="nav-item"><a class="nav-link" href="tel:{{app('setting')['tell_footer_2']}}">{{app('setting')['tell_footer_2']}}</a></li>
                            @endif
                            @if(isset(app('setting')['email_footer']))
                            <li class="nav-item"><a class="nav-link" href="mailto:{{app('setting')['email_footer']}}">{{app('setting')['email_footer']}}</a></li>
                            @endif
                        </ul>
                    </div>
                </div>
